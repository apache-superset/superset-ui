...
export interface SuperChartKernelProps {
  id?: string;
  className?: string;
...
export default class SuperChartKernel extends React.PureComponent<SuperChartKernelProps, {}> {
  ...
  constructor(props: SuperChartKernelProps) {
    super(props);
