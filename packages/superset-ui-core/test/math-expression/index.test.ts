...
describe('evalExpression', () => {
  ...
  it('evaluates infinities correctly', () => {
    const formula = 'x/0';
    expect(evalExpression(formula, 1)).toEqual(Infinity);
    expect(evalExpression(formula, -1)).toEqual(-Infinity);
  });

  it('evaluates powers correctly', () => {
  ...
  it('ignores whitespace and variables on left hand side of equals sign', () => {
    expect(evalExpression('y=x+1', 1)).toEqual(2);
    expect(evalExpression('y = x    - 1', 1)).toEqual(0);
  });

  it('evaluates custom operators correctly', () => {
...
describe('isValidExpression', () => {
  it('correctly identifies invalid formulas', () => {
  ...
  it('correctly identifies valid formulas', () => {
