declare module '@yeutech-lab/react-loadable' {
    ...
    namespace Loadable {
      ...
      export interface Loadable {
        <Props, Exports extends object>(options: Loadable.Options<Props, Exports>): React.ComponentType<Props> & Loadable.LoadableComponent;
        Map<Props, Exports extends { [key: string]: any }>(options: Loadable.OptionsWithMap<Props, Exports>): React.ComponentType<Props> & Loadable.LoadableComponent;
        ...
        Capture: React.ComponentType<Loadable.LoadableCaptureProps>;
      }
    }

    const Loadable: Loadable.Loadable;
