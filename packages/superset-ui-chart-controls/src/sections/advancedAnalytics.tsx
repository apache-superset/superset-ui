...
export const advancedAnalyticsControls: ControlPanelSectionConfig = {
  ...
  controlSetRows: [
    ...
    [
      {
        ...
        config: {
          ...
          default: null,
          choices: [
            ['asfreq', 'Null values fill'],
            ['ffill', 'Forward values fill'],
            ['bfill', 'Backward values fill'],
            ['median', 'Median values fill'],
            ['mean', 'Mean values fill'],
            ['sum', 'Sum values fill'],
          ],
    ...
    [
      {
        name: 'resample_fill_zero',
        config: {
          type: 'CheckboxControl',
          label: t('Fill missing values with zero'),
          renderTrigger: false,
          default: false,
          description: t('Fill missing values with zero based on resample rule'),
          visibility: ({ controls }: any) => controls?.resample_method?.value === 'asfreq',
        },
      },
    ],
  ],
