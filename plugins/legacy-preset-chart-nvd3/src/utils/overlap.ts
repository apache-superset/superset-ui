...
export const getRectangle = (element: SVGElement, xOffset = 0, yOffset = 0): Rect => {
...
export const getOverlappingElements = (
  ...
  elements.forEach((e1, index1) => {
    const rect1: Rect = getRectangle(e1, xOffset, yOffset);
    elements.forEach((e2, index2) => {
      if (index2 <= index1) return;
      const rect2: Rect = getRectangle(e2, xOffset, yOffset);
